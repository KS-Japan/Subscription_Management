...
class _FoodViewScreenState extends State<FoodViewScreen>{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(BaseParameters().titleFoodView),//呼び出して当てはめる
          ...
          children: <Widget>[
            ...
            Card(
              child: ListTile(
                ...
                title: Text("TAILORED CAFE Online Store",style: TextStyle(fontSize: 20.0)),
                subtitle: Text('コーヒーのサブスク\n月額2,805円',style: TextStyle(fontSize: 15.0)),
                onTap: () {},
              ),
            ),
            Card(
