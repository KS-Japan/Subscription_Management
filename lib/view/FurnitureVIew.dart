...
class FurnitureViewScreen extends StatefulWidget {
  @override
  _FurnitureViewScreenState createState() => _FurnitureViewScreenState();
}

class _FurnitureViewScreenState extends State<FurnitureViewScreen>{
  //メイン画面
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(BaseParameters().titleFurnitureView),//呼び出して当てはめる
          ...
          children: <Widget>[
            ...
            Card(
              child: ListTile(
                ...
                title: Text("CLAS",style: TextStyle(fontSize: 20.0)),
                subtitle: Text('月額500円～',style: TextStyle(fontSize: 15.0)),
                onTap: () {},
              ),
            ),
